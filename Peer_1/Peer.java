...
class Peer {
	...
	int i=0;
	int j=0;
	String filepath = "Peer1";                                      //Set the path 
	int peerid;
	...
	{
		int serverid = 0;
		int indx = Key.hashCode();                   //Added to Compute Hashcode
		serverid = Math.abs(indx % 3);
		return serverid;
		//return 0;
	}
